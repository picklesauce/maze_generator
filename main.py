...
class Cell:
    ...
    def draw_current_cell(self):
        x,y = self.x*TILE, self.y*TILE
        pygame.draw.rect(sc, pygame.Color("saddlebrown"), (x+self.thickness, y+self.thickness, TILE - self.thickness, TILE - self.thickness))
...
while True:
    ...
    if next_cell:
        ...
        colors.append((min(color,255), 100, 150))
        color += 1
